...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 13, 2022 at 03:58 PM
...
(1, 'Super Laundry', ' Jl. Laswi ciparay, Kec. Ciparay, Bandung', '083865432132'),
...
(111, 'Asep', '   Cangkring', 'L', '087653274643'),
...
(122, 'Badrun', ' Cikopo', 'L', '087642648232');
...
(1, 1, '456A', 113, '2022-03-13 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 0, 0, 'selesai', 'dibayar', 1);
...
--
ALTER TABLE `tb_detail_transaksi`
  ADD CONSTRAINT `relasi detail transaksi dengan paket` FOREIGN KEY (`id_paket`) REFERENCES `tb_paket` (`id_paket`) ON DELETE CASCADE ON UPDATE CASCADE,
